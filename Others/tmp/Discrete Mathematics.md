...
- $n = a_kb^k + a_{k-1}b^{k-1} + \cdots + a_1b + a_0$ ($a_0,..a_k$는 0이 아니고 b보다 작은 음이 아닌 정수)
- 표기: $(a_k, a_{k-1}, \cdots, a_1, a_0)_b$
...
- 8진법 전개로 $(111)_8$인 수의 10진법 전개는?
  - 답: 73
- 10진법 수 12345의 8진법 전개는?
  - 답: $(30071)_8$
    ![picture 59](../../images/TMP_DM_9.png)

### 16진법 전개

- 16진법 전개로 $(E5)_16$인 수의 10진법 전개는?
  - 답: 229
- 10진법 전개로 691의 16진법 전개는?
  - 답: $(2B3)_16$
    ![picture 60](../../images/TMP_DM_10.png)

### 예시 문제

- $(11 1110 1011 1100)_2$의 8진법, 16진법 전개는?

  - 답: 8진법은 $(3724)_8$, 16진법은 $(3EBC)_{16}$
  - 8진법은 뒤에서부터 3개씩 끊어서, 16진법은 뒤에서부터 4개씩 끊어서 계산

- $(765)_8$ 과 $(A8D)_16$ 의 2진법 전개는?

  - 답: $(765)_8$: $(111 110 101)_2$, $(A8D)16$: $(1010 1000 1101)_2$

- $(1110)_2$ + $(1011)_2$는?

  - 답: $(11001)_2$
    ![picture 61](../../images/TMP_DM_11.png)

- $(1110)_2$ \* $(1011)_2$는?
  - 답: $(10011010)_2$
    ![picture 62](../../images/TMP_DM_12.png)
...
- 양의 정수 p는 1과 p로만 나누어 떨어질 때 **소수(prime number)** 이다.
- 소수가 아닌 수는 **합성수(composite number)** 이다.

- 1보다 큰 양의 정수 n은 소수이거나 소수들의 곱으로 나타낼 수 있다.

  - ex) 100 = $2^2 \cdot 5^2$
  - ex) 999 = $3^3 \cdot 37$

- 양의 정수 n에 대해 $\sqrt n$ 보다 작은 수로 나눠지지 않는다면 n은 소수이다.

### 유클리드 정리: 소수의 개수는 무한대이다.

- 증명: 유한 개의 소수 $p_1, p_2, \cdots, p_n$이 있다고 해보자.

  - $q = p_1 \cdot p_2 \cdots p_n + 1$ 이라 해보자.
  - q는 소수이거나 소수들의 곱으로 나타낼 수 있다.
    - 하지만 그 어떤 $p_j$도 q를 나눌 수 없다. 만약 $p_j | q$라면 $p_j | p_1 \cdots p_n$도 성립한다.  
      그러면 $p_j | q - p_1 \cdots p_n$도 만족하기 때문에 $p_j | 1$이 되어버린다.  
      즉 q가 소수들의 곱으로 나타내어질 수 없다.
    - 이렇게 되면 $p_1, p_2, \cdots, p_n$에 속하지 않은 소수가 존재하게 되기 때문에 전제에 모순이 된다.  
      따라서 소수의 개수는 무한대이다.

### 최대 공약수(greatest common divisor)

- 표기: gcd(a, b)
- gcd(a, b)가 1이면 a와 b는 서로소이다.

### 최대 공배수(least common multiple)

- 표기: lcm(a, b)
- 정리: a \* b = gcd(a, b) \* lcm(a, b)

### 유클리드 알고리즘

- 정수 a, b, c, d에 대해 **a = bq + r 이면 gcd(a,b) = gcd(b,r)이다.** (a \> b)

  - 예시: gcd(91, 287)은?
    - 답: 7
    - 풀이: 287 = 91 \* 3 + 14 (a = 287, b = 91, q = 3, r = 14)  
      따라서 gcd(91, 287) = gcd(91, 14) = 7

### 일차 결합(linear combination)

- 문제: gcd(252, 198) = 18임을 252, 198의 일차 결합으로 나타내라.
  ...
  - 답:
    ...
    - (5) (1)~(3)를 거꾸로!
    - (6) 18 = 54 - 1 \* 36
    - (7) 18 = 54 - (198 - 3 \* 54) = -198 + 4 \* 54
    - (8) 18 = -198 + 4 \* (252 - 198) = 4 \* 252 - 5 \* 198

- 연습문제

  - 4.3.33(c): gcd(1001, 1331) = ?
    - 답: 11
  - 4.3.33(d): gcd(54321, 12345) = ?
    - 답: 3
  - 4.3.39(e): 117, 2131의 최대 공약수를 선형 결합으로 구해라.
  - 4.3.39(d): 123, 2347의 최대 공약수를 선형 결합으로 구해라.
